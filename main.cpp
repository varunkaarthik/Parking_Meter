// Calls the functions to calculate parking fees, parking time, and change/ charge for a given amount paid for parking. It then outputs the results in a formatted manner.
